					...
					<form action="tambah-kriteria.php" method="post">
						...
						<div class="sembunyikan form-group">					
							...
							<select name="jenis_nilai" class="form-control" id="jenis-nilai">
								...
								<option value="1">Menggunakan Pilihan Variabel (Sub Kritria)</option>						
							</select>
						</div>
						
						<div class="table-responsive form-group list-var clearfix">					
							<label><h3>Pilihan Variabel</h3></label>
							<table id="pilihan-var" class="table-bordered pure-table pure-table-striped">
								<thead class="table-primary">
									<tr>
										<th style="width: 190px;">Nama Variabel</th>
